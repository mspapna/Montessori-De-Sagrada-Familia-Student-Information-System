  ...
  <section>
    ...
    <h4>Edit student profile.</h4>
		...
		<fieldset>
			...
			<input required type="text" name="student_id" id="student_id" autocomplete="off" value="<?php echo $row[0]; ?>" autofocus />
			<br/>
			...
			<input required type="text" name="course" id="course" value="<?php echo $row[6]; ?>" />
			<br/>
			<label for="year_level">Year Level</label>
			<input required type="text" name="year_level" id="year_level" value="<?php echo $row[7]; ?>" />
			<br/>
			<label for="gender">Gender</label>
			<input required type="text" name="gender" id="gender" value="<?php echo $row[3]; ?>" />
			<br/>
			<label for="contact_no">Contact No.</label>
			<input required type="text" name="contact_no" id="contact_no" value="<?php echo $row[5]; ?>" />
			<br/>
